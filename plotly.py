...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={"color":"#503D36","font-size":24}),#Include style for title
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        import rich 
        rich.print(average_sales)           
        R_chart2  = dcc.Graph(
            figure=px.bar(average_sales,
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Sale by vihicle type"))
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph( figure=px.line(avr_vdata,x='Year',y='Automobile_Sales'),title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year))
